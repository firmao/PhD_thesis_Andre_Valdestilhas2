...
%----DBpediaSameAs
\subsection{Consistency data sources}
...
\begin{itemize}
    ...
    %\item Which datasets contains information about the research topic represented by the URI \url{http://dbpedia.org/page/Pierre_Bourdieu}?
\end{itemize}
